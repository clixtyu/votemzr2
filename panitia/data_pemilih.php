      ...
      $.ajax({
        ...
        success: function(hasil){
          ...
          $('.penampung-edit-pemilih').html(`
            ...
            <div class="alert alert-info">Jika ingin mengganti password, silhakan isi from input password atau jiak tidak, kosongkan saja</div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
     <form action="aksi_insert.php?tambah=data_pemilih" method="post">
      ...
      <div class="form-group">
        <label for="no_hp">No HP</label>
        <input  required="" type="number" id="no_hp" autocomplete="off" name="no_hp" class="form-control">
      </div>
      <div class="form-group">
        <label for="jenis_kelamin">Jenis Kelamin</label>
