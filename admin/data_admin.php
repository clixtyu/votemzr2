        ...
        <table class="table table-hover table-bordered table-striped" id="datatable" style="width:100%">
          <thead>
            <tr>
              ...
              <th class="text-center">Jenis Kelamain</th>
      ...
      $.ajax({
        ...
        success: function(hasil){
          ...
          $('.penampung-edit-admin').html(`
            ...
            <div class="alert alert-info btn-sm">Jika ingin mengganti password, silhakan isi from input password atau jiak tidak, kosongkan saja</div>
            <div class="form-group">
  ...
  <div class="modal-dialog" role="document">
   ...
   <div class="modal-body">
     <form action="aksi_insert.php?tambah=data_admin" method="post">
      ...
      <div class="modal-footer">
        <button type="submit" class="btn btn-primary" name="tambah_admin" id="tombol-tambah-admin">Tambah</button>
